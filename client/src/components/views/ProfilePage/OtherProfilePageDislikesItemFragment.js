...
const OtherProfilePageDislikesItemFragment = (props) => {
    ...
    console.log("OtherProfilePageDislikesItemFragment props: ", props)
...
export default OtherProfilePageDislikesItemFragment
