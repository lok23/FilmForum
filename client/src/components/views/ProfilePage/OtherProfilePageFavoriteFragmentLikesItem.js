...
const OtherProfilePageFavoriteFragmentLikesItem = (props) => {
    ...
    console.log("OtherProfilePageFavoriteFragmentLikesItem props: ", props)
...
export default OtherProfilePageFavoriteFragmentLikesItem
