...
const OtherProfilePageLikesItemFragment = (props) => {
    ...
    console.log("OtherProfilePageLikesItemFragment props: ", props)
...
export default OtherProfilePageLikesItemFragment
